...
class SunstractingPolinoms
{
    static void Main()
    {
        ...
        Console.WriteLine("Result substraction");
        PrintPolinom(SubstractPolinoms(firstPolinom, secondPolinom));
    }

    private static int[] SubstractPolinoms(int[] firstsCoeficients, int[] secondsCoefiecients)
    {
